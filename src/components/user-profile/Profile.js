...
import { Grid, Avatar, Typography, Button, Paper, Divider } from "@material-ui/core";
      ...
      <Paper className={classes.paper}>
        <Grid className={classes.userInfo}>
          ...
          <Grid item md={8} sm={2} xs={6}>
            <Typography className={classes.phone}><LocalPhoneIcon />  +389 72 312 405</Typography>         
          </Grid>
          <Grid item md={8} sm={2} xs={6}>
            <Typography className={classes.mail}><EmailIcon />  ilieva@hotmail.com</Typography>
          </Grid>
          <Grid item md={8} sm={2} xs={6}>
            <Typography className={classes.location}><LocationOnIcon />  Струмица, Република Македонија</Typography>
          </Grid>
        </Grid>
      </Paper>
      </Grid>
