...
const mapDispatchToProps = dispatch => {
    return {
        ...
        getCategories: (token) => {
            dispatch(userActions.getCategories(token))
        }
    }
}
